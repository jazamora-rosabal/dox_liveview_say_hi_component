...
# GET DEFINED RANGE OR CUSTOM
  ...
  def range_definition(time_zone) do
    [ today: %{dates: Helper.now(time_zone) |> range_in_days(), name: "Hoy"},
      ...
      last_7days: %{dates: Helper.now(time_zone) |> Timex.shift(days: -6) |> range_in_days(Helper.now(time_zone)), name: "Últimos 7 días"},
      last_30days: %{dates: Helper.now(time_zone) |> Timex.shift(days: -29) |> range_in_days(Helper.now(time_zone)), name: "Últimos 30 días"},
